---
title: Patterns
description: Move 编程模式或技巧，解决您在为 Sui 区块链开发 Move 包时遇到的逻辑问题。这包括 capabilities、witness 和 transferrable witness、hot potato 以及 ID 指针等。
---
...
Hot Potato 是一种没有 capabilities 的结构体，因此您只能在其模块中打包和解包它。
